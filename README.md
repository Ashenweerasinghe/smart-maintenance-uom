...
**CI/CD:** pushes to `main` are auto-deployed by GitHub Actions ([`.github/workflows/azure-deploy.yml`](.github/workflows/azure-deploy.yml)) using the App Service publish profile stored as the `AZUREAPPSERVICE_PUBLISHPROFILE` repository secret.
